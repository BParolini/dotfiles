# Contempt Culture
by [Aurynn Shaw][contempt]

---
###### tags: `Dev` `Article`
---

So when I started programming in 2001, it was _du jour_ in the communities I participated in to be highly critical of other languages. Other languages sucked, the people using them were losers or stupid, if they would just use a _real language_, such as the one we used, everything would just be _better_.
...
No, really, _cut it out_. If you need to make fun of a language, do it with your own language, inside your own community. JavaScript is really good at this, because they’re trying to help people write better code _within JavaScript_.
...
[intent]: http://www.shakesville.com/2011/12/harmful-communication-part-one-intent.html
